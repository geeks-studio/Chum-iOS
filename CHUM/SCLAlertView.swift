...
public class SCLAlertView: UIViewController {
    ...
    var kWindowWidth: CGFloat = 240.0
...
//        contentView.layer.borderWidth = 0.5
        ...
        baseView.insertSubview(circleBG, atIndex: 1)
...
//        baseView.bringSubviewToFront(contentView)
    ...
    public convenience init (circleHeight:CGFloat, circleOffsetProportion:CGFloat, fontSize:CGFloat = 20, heightOffset:CGFloat = 15, imageProportion:CGFloat = 0.6, windowWidth:CGFloat = 240) {
        self.init()
        kCircleHeightBackground = circleHeight
        kCircleHeight = circleHeight - 12
        kCircleIconHeight = kCircleHeight * imageProportion
    ...
    override public func viewWillLayoutSubviews() {
        ...
        var viewTextHeight = min(suggestedViewTextSize.height, maxViewTextHeight)
...
//        viewText.frame = CGRect(x:12, y:y, width: kWindowWidth - 24, height:kTextHeight)
    ...
    public func showTitle(title: String = "", subTitle: String, duration: NSTimeInterval?, completeText: String?, style: SCLAlertViewStyle, colorStyle: UInt?=0x000000, colorTextButton: UInt?=0xFFFFFF, circleIconImage: UIImage? = nil, attributedTitle:NSAttributedString? = nil) -> SCLAlertViewResponder {
        selfReference = self
        view.alpha = 0
        let rv = UIApplication.sharedApplication().keyWindow! as UIWindow
        rv.addSubview(view)
        ...
        if let attrTitle = attributedTitle {
            self.labelTitle.attributedText = attrTitle
        }
        ...
        UIView.animateWithDuration(0.2, animations: {
            self.baseView.center.y = rv.center.y + self.customViewOffset + 15
            self.view.alpha = 1
            }, completion: { finished in
                UIView.animateWithDuration(0.2, animations: {
                    let point = CGPoint(x: rv.center.x, y: rv.center.y + self.customViewOffset)
